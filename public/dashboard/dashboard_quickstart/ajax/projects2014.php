...
left outer join company on dbo.company.company_recid = dbo.PM_Project.company_recid
left outer join PM_Status on pm_status.PM_Status_RecID = pm_project.pm_status_recid
where year(pm_project.date_entered) = "2014" and dbo.company.company_name = "Breathe America" group by dbo.company.company_name,datename(month,pm_project.date_entered),month(pm_project.date_entered) order by monthNumber');
		}
