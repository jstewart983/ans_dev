...
$projectHours = mssql_query('SELECT dbo.Company_Type.Description as type,dbo.Company_Status.Description as status,dbo.Company.Company_Name,Address_Line1,Address_Line2,City,State_ID,Zip FROM dbo.Company_Address
