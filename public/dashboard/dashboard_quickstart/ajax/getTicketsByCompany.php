...
where Company.Company_Name"'.$company.'" Company.Company_name != "Advanced Network Solutions" and Company.Company_name != "Catchall (from email connector)" and company.company_name !="Results Physiotherapy" and (dbo.SR_Board.Board_Name = "My Company/Service"
