  ...
  $.ajax({
    ...
    success:function(json){
        ...
        //$("#title #ticketsClosed").fadeOut(500,function(){
          ...
          var $span2 = $('<p data-toggle="tooltip" title="Green: tickets > 0; Yellow: tickets > -50 & tickets <0; Red:tickets<-50" id="vsTickets" style="text-align:center;"><span style="text-align:center;color:'+color+';">'+json[0]['Difference']+'</span> this time last week</p>')
    ...
    $.ajax({
      ...
      success:function(json){
        ...
        if(parseInt(json[0]["Difference"])>1){
            color = "#E74C3C;";
          json[0]["Difference"] = "+"+json[0]["Difference"];
        }else if(parseInt(json[0]["Difference"])> 20 && parseInt(json[0]["Difference"]) > 0){
          color = "#F1C40F";
        }else{
          color = "#2ECC71;";
        }
