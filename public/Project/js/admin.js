...
function oppHistory(value) {
  ...
  $.ajax({
    ...
    success: function(json){
      ...
      //$('#timelineSection2').fadeOut(500, function() {

    // var $span1 = $('<div id="timelineSection2" style="margin-top:11px;"class="row"><div class="panel panel-default"><div style="text-align:center;"class="panel-heading"><p>Opportunity Timeline</p></div><div  class="panel-body"><div  id="timeline2" class="col-md-12"></div></div></div></div>');
     //var $span2 = $('<canvas style="background-color:#F7E109;"  class="col-md-3" id="projectsCreated" height="auto" width="200"></canvas>');
     //$("#timelineSection2").replaceWith($span1);
     //$("#openProjects").replaceWith($span2);
     //$span1.fadeIn(1200);
