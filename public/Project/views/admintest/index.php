          ...
          <div  class="col-md-5">
            ...
            <div class="panel panel-default">
              <div style="min-height:100px;" class="panel-body">
                        ...
                        <div style="height:95% !important;" id="left"  class="container">
                    </div>
            ...
            <div  class="col-md-5">
              ...
              <div class="panel panel-default">
                <div style="min-height:100px;" class="panel-body">
                    <div style="height:95% !important;" id="right"  class="container">
                </div>
...
<option value="Idea">Idea</option>
        ...
        $.ajax({
          ...
          success:function(json1){
            ...
            for(var i = 0; i < json1.length; i++){
              $('#left').append('<span permissionid="'+json1[i]['user_group_id']+'"  href="#" style="margin:5px;text-align:center;"class="btn btn-lg btn-success">'+json1[i]['user_group_name']+'</span>');
              permissions.push(json1[i]['user_group_name']);
            }
            if(permissions.length == 0){
              $('#left').append('<h1 id="gotNone">Aint Got None</h1>');
            }
              ...
              success:function(json2){
                ...
                for(var i = 0; i < json2.length; i++){
                  ...
                  if(jQuery.inArray(json2[i]['user_group_name'],permissions) == -1){
                    $('#right').append('<span permissionid="'+json2[i]['user_group_id']+'" href="#" style="margin:5px;text-align:center;"class="btn btn-lg btn-default">'+json2[i]['user_group_name']+'</span>');

                  }
                }
                //if(json2.length == 0){
                  //$('#right').append('<h1 id="gotSome">You Got Em All</h1>');
                //}
              }
            });
          }
           ...
           $('#userDetail').removeClass('hidden');
             ...
             .on('drag',function(el){
               ...
               //el.className =el.className.replace('btn btn-lg btn-warning','');
             })
             .on('drop',function(el){
               $.ajax({
                 type:"GET",
                   ...
                   if(answer[0]['count'] == 0){
                     ...
                     setTimeout(function(){
                       if($(el).parent().attr('id') == 'left' ){
                         ...
                         $.ajax({
                           type:"POST",
                           url:"../../ajax/setPermissions.php?user="+$user+"&permission="+$permission+"&delete=false",
                           success:function(stuff){
                             console.log(stuff);
                             el.className = 'btn btn-lg btn-success';
                           }
                         });
                         ...
                         $.ajax({
                           type:"POST",
                           url:"../../ajax/setPermissions.php?user="+$user+"&permission="+$permission+"&delete=true",
                           success:function(stuff){
                             console.log(stuff);
                             el.className = 'btn btn-lg btn-default';
                           }
                         });
  ...
  <script href="../../libraries/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
