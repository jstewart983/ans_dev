...
<html lang="en">
    <head>
        ...
        <title>Service Delivery | Client IT Managers</title>
            ...
            <div style="border-top:1px solid #ddd;border-left:1px solid #ddd;border-right:1px solid #ddd;border-bottom:1px solid #ddd;border-radius: 4px;background-color:#fff;"class="col-md-6">
                <div style="padding:5px;">
                    <ul class="nav nav-pills">
                        ...
                        <li role="presentation"><a style="color:#414141;"href="../servicedesk">Service Desk</a></li>
                        <li role="presentation"class="active"><a style="background-color:#F78E1E;color:#fff;"href="#">Client IT Managers</a></li>
