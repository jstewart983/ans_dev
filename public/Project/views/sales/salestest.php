...
<div style="background-color:#fff;" class="navmenu navmenu-default navmenu-fixed-left offcanvas">
        ...
        <div class="col-lg-5 col-lg-offset-4">
          <div class="bt-toolbar">
            <div id="navButtons" class="btn-group">
              <a id="lookupButton" class="btn btn-primary active">Prospect Lookup <span class="fui-search"></span></a>
              <a id="formButton" class="btn btn-primary">Request Form <span class="fui-list-columned"></span></a>
              <a id="dashboardButton"class="btn btn-primary">Request Dashboard <span class="fui-window"></span></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="prospectLookupView"class="hidden">
      <div  style="margin-top:52px;" class="row">
  ...
  <div id="requestFormView" class="hidden">
    <
    <div style="margin-top:52px;" class="row">
      <div class="col-md-12">
  ...
  <div id="requestDashboardView" class="hidden">
    <div  style="margin-top:52px;" class="row">
