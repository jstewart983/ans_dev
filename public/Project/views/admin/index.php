...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"a5c71d8ce0",applicationID:"7511574",sa:1,agent:"js-agent.newrelic.com/nr-627.min.js"}
    ...
    <link rel="stylesheet" href="../../views/admintest/dragula.min.css">
    ...
    <div style="margin-top:82px;"class="container">
      ...
      <div id="userView">
        ...
        <div style="margin-top:82px;" class="row">
          ...
          <div id="choice4" class="col-md-5">
            <a href="#">
              <div class="panel panel-default">
                <div class="panel-body">
                  <h5 style="text-align:center;">Documentation <span class="glyphicon glyphicon-list-alt"></span></h5>
        ...
        <div style="margin-top:82px;" class="row">
          ...
          <div id="choice4" class="col-md-5">
            <a href="#">
              <div class="panel panel-default">
                <div class="panel-body">
                  <h5 style="text-align:center;">Query Editor <span class="glyphicon glyphicon-console"></span></h5>
        ...
        <div id="userDetail"  class="hidden">
          <div class="row">
            <div class="col-md-1">
              <a  id='backTable' href='#' class='btn btn-xs btn-default'><span class='fui-triangle-left-large'></span> back</a>
            </div>
          ...
          <div  class="row">
              ...
              <div class="row">
                ...
                <div class="panel panel-default">
                  <div style="padding:0px;" class="panel-body">
                    <img style="height:100%;width:100%;" src="http://cdn.photoaffections.com/images/icon-profile.png" alt="" />
                  </div>
                </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input id="full_name" class="form-control login_input" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name"/>

                    </div>
                    <div class="form-group">
                      <label for="user_name">Username:</label>
                      <input id="user_name" class="form-control login_input" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" />

                    </div>

                      <div class="form-group">
                        <label for="user_email">Email:</label>
                        <input id="user_email" class="form-control login_input" type="email" name="user_email" />
                      </div>


                      <div class="form-group">
                        <input  type="submit"  name="register" style="width:100%;" class="btn btn-md btn-success" value="Save" />
                      </div>
                  </div>
              </div>
              <div class="row">
            ...
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <h5 style="text-align:center;">Configure Permissions</h5>
              ...
              <div  class="col-md-6">
                ...
                <div class="panel panel-default">
                  <div style="color:#fff;background-color:#708090;" class="panel-heading">
                    Assigned Permissions
                  </div>
                  <div id="leftPanel" style="min-height:100px;" class="panel-body">
                    <div style="min-height:200px;height:100% !important;width:100% !important;" id="left">
                    </div>
                ...
                <div  class="col-md-6">
                  ...
                  <div class="panel panel-default">
                    <div style="color:#fff;background-color:#778899;" class="panel-heading">
                      Available Permissions
                    </div>
                    <div id="rightPanel" style="min-height:100px;" class="panel-body">
                        <div style="min-height:200px;height:100% !important;width:100% !important;" id="right" >
                    </div>
...
<option value="Idea">Idea</option>
    ...
    <script src="../../views/admintest/dragula.min.js"></script>
