...
<div style="background-color:#fff;" class="navmenu navmenu-default navmenu-fixed-left offcanvas">
      ...
      <ul class="nav navmenu-nav">
        ...
        <li class="active"><a href="../../client services/">Client Services</a></li>
    ...
    <div style="margin-top:52px;"class="container">
        <div style="z-index:999;" class="row">
            <div style="border-top:1px solid #ddd;border-left:1px solid #ddd;border-right:1px solid #ddd;border-bottom:1px solid #ddd;border-radius: 4px;background-color:#fff;"class="col-md-4">
                <div style="margin-left:35px;padding:5px;">
                    <ul class="nav nav-pills">
                        <li role="presentation"><a style="color:#414141;"href="../">Sales Dashboard</a></li>
                        <!--<li role="presentation"><a style="color:#414141;"href="serice desk/">Pipeline</a></li>-->
                        <li role="presentation" class="active"><a style="color:#fff;background-color:#F78E1E;"href="#">Client Analysis</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-2">
              <div id="dropdown" class="dropdown">
                <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">View by Client <span class="caret"></span>
                </button>

                <ul style='width:100%;overflow-y: scroll !important;height:495px'class="dropdown-menu" role="menu" id="clientTable" aria-labelledby="menu1">
            ...
            <div class="col-md-2">
              <button href="#" data-toggle="modal"data-target="#basicModal1"type="button" class="btn btn-warning" name="button">Known Issues <span class="fui-alert-circle"></span></button>
            </div>

            <!--<div class="col-md-2">
              <div class="dropdown">
                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">View by Industry <span class="caret"></span>
                </button>
                <form method="post" id="companyForm">
                  <ul style='width:100%;overflow-y: scroll !important;height:295px'class="dropdown-menu" role="menu" id="clientTable">
         ...
         <div style="margin-top:11px;"class="row">
                ...
                <div class="panel panel-default">
                  ...
                  <div id="title"class="panel-body">
                    <h1 style="text-align:center;"id="openTickets">0</h1>
                  </div>
                </div>
            </div>
                ...
                <div id="wherethestuffis" class="col-lg-6">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                          ...
                          <canvas id="osType"  style="height:200px;width:500px;"></canvas>
                      </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p style="color:#E74C3C;">
                                  <span class="fui-alert-circle"></span> There is an issue in the client analysis view where the "OS Breakdown" chart will not load or refresh when certain clients are selected from the dropdown.
                                </p>
