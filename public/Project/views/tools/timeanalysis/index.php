...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"a5c71d8ce0",applicationID:"7511574",sa:1,agent:"js-agent.newrelic.com/nr-627.min.js"}
    ...
    <![endif]-->
        ...
        <script>
            ...
            document.getElementById("title").innerHTML = "<span class='fui-time'></span> "+x;
        ...
        <div style="margin-top:22px;" class="row">
          ...
          <div class="col-md-6">
            ...
            <div style="text-align:center;" class="input">
              ...
              <select id="teamOptions" class="form-control" type="dropdown" name="name" placeholder="">
                <option value="All">
                  All
                </option>
                <option value="solutiondelivery">
                  Solution Delivery
                </option>
                <option value="servicedelivery">
                  Service Delivery
                </option>
                <option value="managedservices">
                  Managed Services
                </option>
                <option value="fieldservices">
                  Field Services
                </option>
          ...
          <div class="col-md-5">
            <div id="hoursByBoard">
              <canvas id="hoursByBoardChart" width="300" height="300"></canvas>
            </div>
          </div>
        </div>
        </div>
...
<option value="Idea">Idea</option>
    ...
    <script type="text/javascript" src="../../../js/timeanalysis.js"></script>
