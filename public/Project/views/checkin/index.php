...
border-color: #2ecc71;
    ...
    <body class="canvas">
          <div style="background-color:#3498DB;" class="navbar navbar-default navbar-fixed-top">

            <div class="col-md-3">

            </div>
            <div class="col-md-5">
              <h2 style="margin-top:12px;text-align:center;font-size:20px;display: block;color:#fff;"id="title"></h2>
    ...
    <div style="margin-top:52px;"class="container">
      ...
      <div id="po_section"  class="row">
          <legend style="margin-left:1%;">Search by PO#</legend>
            <div class="col-md-2">
                <input class="form-control" type="text" name="po" id="po" placeholder="PO#">
            </div>
          <div class="col-md-2">
              <input style="background-color:#ddd;border-color: #ECF0F1!important;" class="form-control" type="text" disabled="disabled" name="po_results" id="po_results">
          </div>
          </div>
        </div>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div id="form" style="margin-top:10px;" class="row">
              <form class="form-horizontal">
                <fieldset>
              <legend style="margin-left:1%;">Check in/out item <span id="server_message" class="hidden"></span></legend>
                <div id="member"class=" col-md-2">
                ...
                <div class="col-md-2">
                  <select id="client2" class="form-control">
                    <option value="one">Select Client</option>
                  </select>
                </div>
                <div class="col-md-2">
                  <select id="in_out" class="form-control">
                    <option value="none">In or Out?</option>
                      <option value="1">In</option>
                        <option value="0">Out</option>
                  </select>
                </div>
                <div class="col-md-2">
                <input class="form-control" type="text" name="barcode" id="barcode" placeholder="scan model #">
                </div>
                <div  class="col-md-4">
                  <button style="text-align:center;" class="btn btn-default" type="button" id="check_in" name="check_in" value="Done">Check In/Out</button>
                </div>
                </fieldset>
                </form>
            </div>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div style="margin-top:20px;" class="row">
              <legend style="margin-left:1%;">Inventory Timeline</legend>
            <div id="item_table" class="col-md-12">
