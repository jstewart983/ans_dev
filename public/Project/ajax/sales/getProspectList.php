...
$clientList = mssql_query('SELECT distinct dbo.Company.Company_Name,dbo.Company_Status.Description FROM dbo.Company_Address
...
$company = $row['Company_Name'];
  ...
  echo "<tr class='co'>";
    echo "<td id='company'>".$row['Company_Name']."</td>";
     echo "<td id='status'>".$row['Description']."</td>";
    echo "</tr>";
