...
WHERE     (dbo.SO_Team.Team_Flag = 0) AND (dbo.SO_Team.Owner_Flag = 1) and year(dbo.SO_Opportunity.Date_Close_Expected) = year(getdate()) and
dbo.SO_Opp_Status.Description = "Open" and dbo.SO_Opportunity.Date_Close_Expected < getdate() and company.company_name <> "Advanced Network Solutions"
...
dbo.Order_Header.Total, dbo.order_header.Order_Date
