...
if(isset($_GET['board'])){
  $board = $_GET['board'];
	...
	$query = 'select company.company_name,DATEDIFF(DAY, sr_service.date_entered, getdate()) as daysOpen,sr_service.sr_service_recid,sr_status.description as status, sr_service.date_entered,sr_urgency.description as urgency,sr_service.summary
  from sr_service
