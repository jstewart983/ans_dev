...
SELECT   dbo.Time_Entry.Date_Start as dateEntry,

                      SUM(CASE WHEN dbo.time_entry.PM_Project_RecID IS NOT NULL THEN dbo.time_entry.Hours_Actual ELSE 0 END) AS Project_Hours
...
group by dbo.Time_Entry.Date_Start');
