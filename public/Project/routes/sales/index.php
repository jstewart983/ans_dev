<?php
$admins = array('cwhite','bflippo','jstewart','rpinson','gsummey','aholst','plane@ansolutions.com','plane');
$user_group = array('jcufr','jlaudin','ckelly','sthorsen','jmiser','fmonroe','pcrocker');
/**
